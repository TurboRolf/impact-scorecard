        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredCompanies.map((company) => (
            <CompanyCard 
              ...
              overallRating={Number(company.avg_overall_rating || 0)}
              environmentRating={Number(company.avg_environment_rating || 0)}
              laborRating={Number(company.avg_labor_rating || 0)}
