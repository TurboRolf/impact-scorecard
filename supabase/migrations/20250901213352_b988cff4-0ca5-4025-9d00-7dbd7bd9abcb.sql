...
ALTER TABLE boycotts 
ADD CONSTRAINT boycotts_category_id_fkey 
FOREIGN KEY (category_id) REFERENCES categories(id);

ALTER TABLE boycotts 
ADD CONSTRAINT boycotts_organizer_id_fkey 
FOREIGN KEY (organizer_id) REFERENCES profiles(user_id);
...
ALTER TABLE user_company_stances 
ADD CONSTRAINT user_company_stances_company_id_fkey 
FOREIGN KEY (company_id) REFERENCES companies(id);

ALTER TABLE user_company_stances 
ADD CONSTRAINT user_company_stances_user_id_fkey 
FOREIGN KEY (user_id) REFERENCES profiles(user_id);

ALTER TABLE boycott_participants 
ADD CONSTRAINT boycott_participants_boycott_id_fkey 
FOREIGN KEY (boycott_id) REFERENCES boycotts(id);

ALTER TABLE boycott_participants 
ADD CONSTRAINT boycott_participants_user_id_fkey 
FOREIGN KEY (user_id) REFERENCES profiles(user_id);
